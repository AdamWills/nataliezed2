...
add_image_size( 'featured-thumb-300', 300, 300, true );
/* 
		...
		<article id="comment-<?php comment_ID(); ?>" class="clearfix">
			<header class="comment-author vcard">
			    ...
			    */ 
			    ...
			    ?>
			    <img data-gravatar="http://www.gravatar.com/avatar/<?php echo md5($bgauthemail); ?>?s=160" class="load-gravatar avatar avatar-48 photo" height="160" width="160" src="<?php echo get_template_directory_uri(); ?>/library/images/nothing.gif" />
